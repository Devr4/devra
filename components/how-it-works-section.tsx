...
const offeringIcons: LucideIcon[] = [Globe, Smartphone, ShoppingCart, Sparkles]
const offeringTags = [
  ["Next.js", "React", "Node.js"],
  ["React Native", "PWA", "iOS/Android"],
  ["Shopify", "Stripe", "Headless"],
  ["OpenAI", "LLMs", "Automation"],
]
const offeringAccents = [
  "from-devra-gold/20 to-transparent",
  "from-devra-purple/20 to-transparent",
  "from-devra-gold/20 to-transparent",
  "from-devra-purple/20 to-transparent",
]
    ...
    <section id="what-we-build" className="relative py-24 md:py-32">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          <p className="text-lg text-muted-foreground text-pretty">{t.whatWeBuild.description}</p>
        </div>

        {/* Offerings Grid */}
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {t.whatWeBuild.offerings.map((offering, index) => {
            const Icon = offeringIcons[index]
            const tags = offeringTags[index]
            const accent = offeringAccents[index]
            ...
            return (
              <div key={offering.title} className="group relative">
                ...
                <div className="relative h-full bg-card border border-border rounded-2xl p-6 md:p-8 hover:border-devra-purple/50 transition-all duration-300 hover:shadow-xl hover:shadow-devra-purple/5">
                  {/* Gradient accent */}
                  <div
                    className={`absolute top-0 left-0 right-0 h-32 bg-gradient-to-b ${accent} rounded-t-2xl opacity-0 group-hover:opacity-100 transition-opacity`}
                  />
